...
{      
    ...
    RTC_Handler.Init.SynchPrediv=0XFF;            //RTC同步分频系数(0~7FFF) 128*256=32768 ,LSE=32.768KHz,所以RTC时钟频率1Hz。    
    ...
    { 
        RTC_Set_Time(21,05,00,RTC_HOURFORMAT12_PM);	        //设置时间 ,根据实际时间修改
				RTC_Set_Date(17,12,11,1);		                    //设置日期
